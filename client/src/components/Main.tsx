      ...
      <main className="main-container">
        ...
        <section className="right-section reveal reveal--right">
          ...
          <p className="subtitle">
            أنا بشرى، متخصصة في كتابة المحتوى الإبداعي وتصميم الجرافيك، أعمل في
            مجال صناعة المحتوى الرقمي وبناء الهويات البصرية. أمتلك خبرة في إعداد
            المحتوى للمنصات المختلفة، ووضع خطط محتوى استراتيجية مدروسة تخدم
            الأهداف التسويقية وتخاطب الجمهور بوضوح واحتراف. أقدّم خدمات متكاملة
            تشمل كتابة المحتوى التسويقي، تصميم الجرافيك للسوشيال ميديا
            والمطبوعات، بالإضافة إلى الإشراف على المتدربين ونقل الخبرة العملية
            وفق متطلبات السوق. أؤمن بأن المحتوى الناجح لا يعتمد على الجمال فقط،
            بل على الفكرة، الرسالة، والأثر الحقيقي. أحرص في أعمالي على الجمع بين
            الإبداع، البساطة، والدقة، مع تركيز دائم على تقديم قيمة حقيقية تعكس
            هوية المشروع وتدعم نموه.
          </p>
